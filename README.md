...
## Disclaimer
The notebook can be used to predict dog breeds and in the end this algorithm can be used to create a web-app.

The target was to achieve a CNN with >1% accuracy. The network described above achieved 8.73% without any fine-tuning of parameters and without any augmentation on the data.
...
The architecture below has a testing accuracy of 83.2356%.

 --if a dog is detected in the image, return the predicted breed.
 --if a human is detected in the image, return the resembling dog breed.
 --if neither is detected in the image, provide output that indicates an error.
## Blogpost link: 
### https://medium.com/@rishi.insightlenz/dog-breed-classifier-cnn-a656794aa223
